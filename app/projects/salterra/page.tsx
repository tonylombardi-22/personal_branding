...
export const metadata: Metadata = {
  ...
  description: "How Tony Lombardi built a market-ready consulting brand for a financial services operations leader launching independently.",
};
        ...
        <section className="page-hero">
          <div className="container">
            <div className="page-hero-content fade-up">
              ...
              <p className="page-subline">From experienced operator to market-ready consulting brand. A ground-up build — positioning, website, service architecture, and practical launch support.</p>
          ...
          <div className="container">
            <div className="cs-overview-grid">
              <div className="fade-up">
                ...
                <p className="inner-copy">Salterra Enterprises is the independent consulting brand of a senior financial services operations leader with decades of enterprise-level experience spanning banking, insurance, and financial operations management.</p>
